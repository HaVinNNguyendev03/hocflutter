...
class MyApp extends StatelessWidget {  // như đã nói widget cũng là một class và nó đang kế thừa StatelessWidget
  const MyApp({super.key});  // đây là contrustor của class,nó có tác dụng trỏ tới superclass để truyền key
  // This widget is the root of your application.
  @override // trong oop nó là từ khóa giúp lớp con có thể triển khai theo các cách khác nhau từ phương thức(build) của lớp cha 
